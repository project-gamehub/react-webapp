const API_GATEWAY_URL = "https://game-hub.duckdns.org/backend/api";
...
export const CHAT_SERVICE_SOCKET_URL =
    "https://game-hub.duckdns.org/backend/chat";
export const TICTACTOE_SOCKET_URL =
    "https://game-hub.duckdns.org/backend/tictactoe";
...
export const LOGIN_PAGE_BANNER_URL =
    "https://i.ibb.co/myDQjv3/login-banner.jpg";
